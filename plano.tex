...
\centro{\textit{Campus} Itabaiana}
 \departamento{Direção de Desenvolvimeento de Ensino}
\local{Itabaiana}
\data{\today}
...
\codigo{FIL1} % Código da disciplina
\semestre{2021/1}
\aula{Plano de Aula}
\titulo{O nascimento do pensar filosófico: do mito à Filosofia}
...
\campus{IFPB - PB Campus –- Itabaiana, Paraíba}
\turma{Automação Industrial e Eletromecânica}
\horario{00:00}
...
% \begin{thebibliography}{}
	...
	\bibitem{MURCHO} MURCHO, Desidério. (2000) ``O que é Filosofia?'' \textit{Crítica na Rede}.
